...
<body>
  ...
  <div class="row">
  	<div class="small-12 medium-12 large-12 small-centered columns">
  		<header>
  			<h1><a href="/"><img src="/img/catodo.png" alt="Catodo"></a></h1>
  			<h2 style="margin-top: 20px">I believe that code is poetry and I express myself with it</h2>
  		</header>
  	</div>
  	<div class="small-12 medium-12 large-12 small-centered columns">
  ...
  <div class="row">
  	<div class="small-12 medium-12 large-12 columns">
  		<footer>
  			<ul>
  				<li>&copy; 2012-<?php echo date('Y') ?> by Catodo. <a href="/privacy-policy">Cookie and Privacy policy</a></li>
